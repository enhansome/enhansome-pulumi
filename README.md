...
> Your [contributions](https://github.com/pulumiverse/awesome-pulumi/blob/master/CONTRIBUTING.md) ⭐ 265 | 🐛 4 | 📅 2026-03-31 are welcome!
...
* [`jaxxstorm/pulumi-scaleway`](https://github.com/jaxxstorm/pulumi-scaleway) ⭐ 47 | 🐛 16 | 🌐 Makefile | 📅 2026-09-02 - Provision to Scaleway using Pulumi
...
* [`localstack/pulumi-local`](https://github.com/localstack/pulumi-local) ⭐ 91 | 🐛 2 | 🌐 Python | 📅 2026-02-24 - Use Pulumi with LocalStack, easy-to-use test/mocking for cloud apps
...
* [`tmeckel/pulumi-tf-provider-cookiecutter`](https://github.com/tmeckel/pulumi-tf-provider-cookiecutter) ⭐ 14 | 🐛 12 | 🌐 Python | 📅 2026-08-25 - A Cookiecutter template to create a Pulumi provider out of a Terraform Provider using TF Bridge
...
* [`webiny/webiny-js`](https://github.com/webiny/webiny-js) ⭐ 8,032 | 🐛 351 | 🌐 TypeScript | 📅 2026-09-05 - Platform for building serverless applications and APIs
...
* [`cloudy-sky-software/pulschema`](https://github.com/cloudy-sky-software/pulschema) ⭐ 20 | 🐛 7 | 🌐 Go | 📅 2026-09-03 - Library for developing native providers from OpenAPI specs
...
[^dailydev]: [Daily.dev tech stack](https://github.com/dailydotdev/daily#-tech-stack) ⭐ 20,059 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-25
