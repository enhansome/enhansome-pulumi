...
* [`webiny/webiny-js`](https://github.com/webiny/webiny-js) ⭐ 8,031 | 🐛 350 | 🌐 TypeScript | 📅 2026-08-17 - Platform for building serverless applications and APIs
...
* [`cloudy-sky-software/pulschema`](https://github.com/cloudy-sky-software/pulschema) ⭐ 19 | 🐛 6 | 🌐 Go | 📅 2026-08-17 - Library for developing native providers from OpenAPI specs
...
[^dailydev]: [Daily.dev tech stack](https://github.com/dailydotdev/daily#-tech-stack) ⭐ 20,023 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-12
